...
public final class OnClickActivity extends RxActivity {

  @Override protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    setContentView(R.layout.common);

    findViewById(R.id.bt_ask_permissions).setVisibility(View.VISIBLE);
    findViewById(R.id.bt_ask_permissions).setOnClickListener(view -> {
